...
export default function Home() {
  return (
    <main className="bg-white relative hero min-h-screen flex flex-col items-center justify-center">
      <Navbar/>
      <h1 className='text-[18vw] md:text-[16vw] drop-shadow-2xl rotate-12 skew-x-12 font-bold uppercase'>Tchisama</h1>
      ...
      <div className='absolute container mx-auto flex flex-col gap-4 bottom-0 md:bottom-[8%] left-0 p-4 md:p-10 items-start'>
        <p className='text-lg font-medium uppercase w-full max-w-sm'>a full stack web devloper , and designer based on morocco</p>
